...
def hopper():
    ...
    bcq = BC.from_json('./poisoned_model_traing/hopper_trigger_bc.json')
    bcq.load_model('./poisoned_model_traing/hopper_trigger_bc.pt')
...
def waler2d():
    ...
    bcq = BC.from_json('./poisoned_model_traing/walker_trigger_cql.json')
